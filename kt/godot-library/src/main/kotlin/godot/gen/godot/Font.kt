...
public open class Font internal constructor() : Resource() {
  ...
  public fun getStringSize(
    ...
    TransferContext.writeArguments(STRING to text, LONG to alignment.id, DOUBLE to width.toDouble(), LONG to fontSize.toLong(), OBJECT to jstFlags, LONG to direction.id, LONG to orientation.id)
  ...
  public fun getMultilineStringSize(
    ...
    TransferContext.writeArguments(STRING to text, LONG to alignment.id, DOUBLE to width.toDouble(), LONG to fontSize.toLong(), LONG to maxLines.toLong(), OBJECT to brkFlags, OBJECT to jstFlags, LONG to direction.id, LONG to orientation.id)
  ...
  public fun drawString(
    ...
    TransferContext.writeArguments(_RID to canvasItem, VECTOR2 to pos, STRING to text, LONG to alignment.id, DOUBLE to width.toDouble(), LONG to fontSize.toLong(), COLOR to modulate, OBJECT to jstFlags, LONG to direction.id, LONG to orientation.id)
  ...
  public fun drawMultilineString(
    ...
    TransferContext.writeArguments(_RID to canvasItem, VECTOR2 to pos, STRING to text, LONG to alignment.id, DOUBLE to width.toDouble(), LONG to fontSize.toLong(), LONG to maxLines.toLong(), COLOR to modulate, OBJECT to brkFlags, OBJECT to jstFlags, LONG to direction.id, LONG to orientation.id)
  ...
  public fun drawStringOutline(
    ...
    TransferContext.writeArguments(_RID to canvasItem, VECTOR2 to pos, STRING to text, LONG to alignment.id, DOUBLE to width.toDouble(), LONG to fontSize.toLong(), LONG to size.toLong(), COLOR to modulate, OBJECT to jstFlags, LONG to direction.id, LONG to orientation.id)
  ...
  public fun drawMultilineStringOutline(
    ...
    TransferContext.writeArguments(_RID to canvasItem, VECTOR2 to pos, STRING to text, LONG to alignment.id, DOUBLE to width.toDouble(), LONG to fontSize.toLong(), LONG to maxLines.toLong(), LONG to size.toLong(), COLOR to modulate, OBJECT to brkFlags, OBJECT to jstFlags, LONG to direction.id, LONG to orientation.id)
